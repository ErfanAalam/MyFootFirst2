...
const GoogleRetailer = () => {
    ...
    const validateForm = () => {
        ...
        if (!businessName || !businessType || !contactFirstName || !contactLastName || !contactRole || !address || !city || !state || !postalCode || !country || !countryCode || !callingCode || !phone || !monthlyVolume || !sellsOrthotics) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (!currentUser) {
                showAlert("Error", "No user is currently signed in.", 'error');
                return;
            }
